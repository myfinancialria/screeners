"""
Generate the static website (site/index.html + site/data.csv) from a fresh
...
<a href="data.csv">download CSV</a> · <a href="performance.html">📊 performance dashboard →</a> · <a href="journal.html">🤖 strategy paper-trading journal →</a></p>
